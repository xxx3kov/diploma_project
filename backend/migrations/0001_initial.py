    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "building",
                    models.CharField(blank=True, max_length=20, verbose_name="Корпус"),
                ),
                (
                    "structure",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="Строение"
                    ),
                ),
                (
                    "apartment",
                    models.CharField(
                        blank=True, max_length=20, verbose_name="Квартира"
                    ),
                ),
                (
                    "user",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                related_name="categories", to="backend.shop", verbose_name="Магазины"
            ),
        ),
        migrations.CreateModel(
